...
export default async function SettingsPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-10">
      <h1 className="text-3xl font-bold mb-8">ConfiguraÃ§Ãµes</h1>
      <div className="space-y-4">
        ...
        >
          ...
          <div>
            ...
            <p className="text-muted-foreground text-base">
              Gerencie seu plano, cartÃ£o e histÃ³rico de pagamentos.
            </p>
          </div>
        </Link>
        <div className="flex items-center gap-4 border border-border p-6 bg-muted/30">
          ...
          <div>
            <h2 className="text-lg font-bold">{session.user.name ?? "UsuÃ¡rio"}</h2>
